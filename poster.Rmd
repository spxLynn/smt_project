...
### Conclusion
Area selected: Kutai Kartanegara and parts of Penajam Paser

While the most ideal location identified is located partly in Kutai Kartanegara and Penajam Paser, the two regencies intersect in the midpoint between the two major cities in East Kalimantan, Balikpapan and Samarinda. With the new site’s proximity to the two cities, it could take advantage of their existing infrastructure despite it being the least important criteria for our AHP analysis. And more importantly, this new site can potentially solve many of Jakarta’s most pressing issues (traffic, pollution, overpopulation, etc).
